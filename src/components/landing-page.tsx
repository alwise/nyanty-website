                ...
                <div className="flex items-center space-x-4">
                  <div className="w-80 rounded-lg overflow-hidden">
                    <Image
                      ...
                      height="120"
                      src="https://images.unsplash.com/photo-1628294895933-4360614f39dd?q=80&w=2032&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      width="120"
                    />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="flex items-center space-x-4">
                  <div className="w-80 rounded-lg overflow-hidden">
                    <Image
                      ...
                      className="aspect-[1/1] object-cover object-center"
                      height="120"
                      src="https://plus.unsplash.com/premium_photo-1661778773089-8718bcedb39e?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                      width="120"
                    />
                  </div>
                  <div className="space-y-1">
