...
export function BgImagesSlider(props: {
    ...
    return (
        <ImagesSlider className="h-[40rem] transition-all duration-700"
            images={images} direction="down">
            <motion.div
            ...
            >
                ...
                <button
                    onClick={() => {
                        document.getElementById(navs.contactUs.id)?.scrollIntoView({ behavior: 'smooth' })
                    }}
